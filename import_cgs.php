						...
						while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
							...
							*/
							...
							if ($cgs_num != '' && $cgs_date != '' && $cgs_exp != '') {
								$sql = "INSERT INTO cooperatives_cgs( cid, cgs_num, cgs_date, cgs_exp )
										VALUES( '$cid', '$cgs_num', '$cgs_date', '$cgs_exp' )";
								query($sql); 
							}
						}
						...
						<div class="row">
						  ...
						  <div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
							  ...
							  <div class="x_content">
								<form id="contact-form" name="contact-form" action="import_cgs.php" method="POST" enctype="multipart/form-data">					
									<fieldset>
