	...
	if (validate_level3(PAGE) == true) {
		...
		if(isset($_POST['submitted'])) { // if submit button has been pressed
			...
			if (query($sql)) {
				...
				header("Location: cocs.php?&deleted_coc=1");
				exit();
			} else {
				?>
				<div class="error">Could not delete certificate of application because: <b><?PHP echo mysqli_error($connection) ?></b>.
			...
			<html lang="en">
			  <head>
				...
				<title>OTC | Delete Certificate of Application</title>
			  ...
			  <body class="nav-md">
				<div class="container body">
				  <div class="main_container">
					...
					$sql = "SELECT c.cnum, DATE_FORMAT(c.cdate, '%m/%d/%y'), 
					  ...
					  <div class="">
						<div class="page-title">
						  <div class="title_left">
							<h3>Delete Certificate of Completion</h3>
						  </div>
							...
							<div class="x_panel">
							  <div class="x_content">
								<br />
									...
									<form action="d_coc.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
									  ...
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">Date of CoC </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
									  ...
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">No. of Hours Earned </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $row[3] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">Date of Expiry </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $row[4] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">Hours Balance </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
		...
		if ($eid != 0) {
			...
			$sql = "SELECT approve_id, eid FROM cocs WHERE cid = '$cid'";
