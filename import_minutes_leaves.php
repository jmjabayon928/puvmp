		...
		if(isset($_POST['submitted'])) { // if submit button has been pressed
				...
				if ($extension != 'csv') {
					...
					if (($handle = fopen($file, "r")) !== FALSE) {
						...
						while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
							...
							$sql = "INSERT INTO cooperatives_cgs( minute, conversion ) VALUES( '$minutes', '$leaves' )";
							query($sql); 
						}
			...
			<html lang="en">
			  <head>
				...
				<title>OTC - Import Minutes - Leaves</title>
					  ...
					  <div class="">
						...
						<div class="row">
						  ...
						  <div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
							  <div class="x_title">
								<h2>Import Minutes - Leaves</h2>
								<div class="clearfix"></div>
							  </div>
							  <div class="x_content">
								<form id="contact-form" name="contact-form" action="import_minutes_leaves.php" method="POST" enctype="multipart/form-data">					
									<fieldset>
