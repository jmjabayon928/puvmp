...
if (isset($_SESSION['user_id'])) {
	if (validate_level(PAGE) == true) {
		...
		if(isset($_POST['submitted'])) { // if submit button has been pressed
			...
			if (query($sql)) {
				// log the activity
				log_user(3, 'activities', $aid);
				
				// redirect
				header("Location: activities.php?tab=2");
				exit();
			} else {
				?>
				<div class="alert alert-danger alert-dismissible fade in" role="alert">
					<strong>Could not delete activity because: </strong><br />
			...
			<html lang="en">
			  <head>
				...
				<title>OTC | Delete Activity</title>
							...
							<div class="x_panel">
							  <div class="x_content">
								<br />
									...
									<form action="d_activity.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
