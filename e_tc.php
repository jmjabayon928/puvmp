	...
	if (validate_level(PAGE) == true) {
		...
		if(isset($_POST['submitted'])) { // if submit button has been pressed
			...
			if (query($sql)) {
				...
				?>
				<div class="error">Could not update transport cooperative details because: <b><?PHP echo mysqli_error($connection) ?></b>.
			...
			<html lang="en">
			  <head>
				...
				<title>OTC | Update TC Details</title>
			  ...
			  <body class="nav-md">
				<div class="container body">
				  <div class="main_container">
					...
					$sql = "SELECT * FROM cooperatives WHERE cid = '$cid'";
					$res = query($sql); 
					$row = fetch_array($res); 
					?>
					  ...
					  <div class="">
						<div class="page-title">
						  <div class="title_left">
							<h3>Update Cooperative Details</h3>
						  </div>
							...
							<div class="x_panel">
							  <div class="x_content">
								<br />
									...
									<form action="e_tc.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
									  ...
									  <div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="cname" name="cname" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row[4] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="addr">Address <span class="required">*</span></label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="addr" name="addr" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row[5] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="chairman">Chairman <span class="required">*</span></label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="chairman" name="chairman" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row[6] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="chairman_num">Chairman's Number </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="chairman_num" name="chairman_num" class="form-control col-md-7 col-xs-12" value="<?php echo $row[7] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="contact_num">Other Numbers </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="contact_num" name="contact_num" class="form-control col-md-7 col-xs-12" value="<?php echo $row[8] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Email </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="email" name="email" class="form-control col-md-7 col-xs-12" value="<?php echo $row[9] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="new_otc_num">OTC Accreditation Number </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="new_otc_num" name="new_otc_num" class="form-control col-md-7 col-xs-12" value="<?php echo $row[12] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label for="new_otc_date" class="control-label col-md-3 col-sm-3 col-xs-12">OTC Accreditation Date </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input id="new_otc_date" name="new_otc_date" class="form-control col-md-7 col-xs-12" type="date" value="<?php echo $row[13] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="new_cda_num">CDA Registration Number </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="new_cda_num" name="new_cda_num" class="form-control col-md-7 col-xs-12" value="<?php echo $row[16] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label for="new_cda_date" class="control-label col-md-3 col-sm-3 col-xs-12">CDA Registration Date </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input id="new_cda_date" name="new_cda_date" class="form-control col-md-7 col-xs-12" type="date" value="<?php echo $row[17] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label for="pa_expiry" class="control-label col-md-3 col-sm-3 col-xs-12">Provisional Accreditation Expiry </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input id="pa_expiry" name="pa_expiry" class="form-control col-md-7 col-xs-12" type="date" value="<?php echo $row[54] ?>">
										</div>
									  </div>
									  <div class="form-group">
