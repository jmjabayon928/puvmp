	...
	if (validate_user() == true) {
		...
		if(isset($_POST['submitted'])) { // if submit button has been pressed
			...
			for ($i=0; $i<$countnames; $i++) {
				$sql = "INSERT INTO towns( did, tname ) VALUES( '$did', '$pcs[$i]')";
				query($sql); 
			}
			  ...
			  <body class="nav-md">
				<div class="container body">
				  <div class="main_container">
					...
					$sql = "SELECT p.pname, d.dnum
							FROM districts d INNER JOIN provinces p ON d.pid = p.pid
							WHERE d.did = '$did'";
					$res = query($sql); 
					$row = fetch_array($res); 
					$pname = $row[0]; 
							...
							<div class="x_panel">
							  <div class="x_content">
								<br />
									...
									<form action="add_town.php" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
									  ...
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="tname">City/Municipality <span class="required">*</span></label>
										<div class="col-md-6 col-sm-6 col-xs-12">
