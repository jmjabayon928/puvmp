...
include("sqli.php");
include("html.php");
define('PAGE', 'd_announcement.php'); 
...
if (isset($_SESSION['user_id'])) {
	if (validate_level(PAGE) == true) {
		...
		if(isset($_POST['submitted'])) { // if submit button has been pressed
			...
			if (query($sql)) {
				// log the activity
				log_user(3, 'announcements', $aid);
				
				// redirect
				header("Location: announcements.php?tab=2");
				exit();
			} else {
				?>
				<div class="alert alert-danger alert-dismissible fade in" role="alert">
					<strong>Could not delete announcement because: </strong><br />
			...
			<html lang="en">
			  <head>
				...
				<title>OTC | Delete Announcement</title>
							...
							<div class="x_panel">
							  <div class="x_content">
								<br />
									...
									<form action="d_announcement.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
