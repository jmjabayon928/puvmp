	...
	if (validate_level(PAGE) == true) {
		...
		<html lang="en">
		  <head>
			...
			<title>OTC | View Employee-Attendance</title>
					...
					<div class="page-title">
					  ...
					  <div class="title_right">
						<div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
							<a href="e_attendance.php?aid=<?php echo $aid ?>" class="btn btn-warning btn-md"><i class="fa fa-pencil"></i> Edit </a>
							<a href="d_attendance.php?aid=<?php echo $aid ?>" class="btn btn-danger btn-md"><i class="fa fa-eraser"></i> Delete </a>
						</div>
					  </div>
					</div>
					<div class="clearfix"></div>
					<div class="row">
						  ...
						  if ($_GET['create'] == 1) {
							  ?>
								<div class="alert alert-success">
								  <strong>Success!</strong> Employee-attendance has been added into the database.
								</div>
							  <?php
						  }
					  }
					  if (isset($_GET['update'])) {
						  if ($_GET['update'] == 1) {
							  ?>
								<div class="alert alert-success">
								  <strong>Success!</strong> Employee-attendance has been updated.
								</div>
							  <?php
						  }
					  }
								  ...
								  <div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
									  <input type="text" readonly class="form-control col-md-7 col-xs-12" value="<?php 
										if ($row[6] == 1) { echo 'Pre';
										} elseif ($row[6] == 2) { echo 'Abs';
										} elseif ($row[6] == 3) { echo 'SL';
										} elseif ($row[6] == 4) { echo 'VL';
										} elseif ($row[6] == 5) { echo 'SPL';
										} ?>">
									</div>
								  </div>
								  <div class="form-group">
