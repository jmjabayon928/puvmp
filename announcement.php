	...
	if (validate_level(PAGE) == true) {
		...
		<html lang="en">
		  <head>
			...
			<title>OTC | View Announcement Details</title>
					...
					<div class="page-title">
					  ...
					  <div class="title_right">
						<div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
							<a href="e_announcement.php?aid=<?php echo $aid ?>" class="btn btn-warning btn-md"><i class="fa fa-pencil"></i> Edit </a>
							<a href="d_announcement.php?aid=<?php echo $aid ?>" class="btn btn-danger btn-md"><i class="fa fa-eraser"></i> Delete </a>
						</div>
					  </div>
					</div>
					<div class="clearfix"></div>
					<div class="row">
					  ...
					  if (isset($_GET['update'])) {
						  if ($_GET['update'] == 1) {
							  ?>
								<div class="alert alert-success">
								  <strong>Success!</strong> Announcement has been updated.
								</div>
							  <?php
						  }
					  }
					  
					$sql = "SELECT DATE_FORMAT(a.adtime, '%b %e, %Y %h:%i %p'), a.aname, 
								a.adesc, a.did, a.remarks, CONCAT(u.lname,', ',u.fname), 
								DATE_FORMAT(a.last_update, '%b %e, %Y %h:%i %p')
							FROM announcements a INNER JOIN users u ON a.last_update_id = u.user_id
							WHERE a.aid = '$aid'";
					$res = query($sql); 
					$row = fetch_array($res); 
						  ...
						  <div class="x_content">
							<br />
								...
								<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
								  ...
								  <div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12">Announcement Name </label>
									<div class="col-md-6 col-sm-6 col-xs-12">
								  ...
								  <div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12">Division Concerned </label>
									<div class="col-md-6 col-sm-6 col-xs-12">
									  <input type="text" readonly class="form-control col-md-7 col-xs-12" value="<?php 
									    if ($row[3] != 0) {
											$sql = "SELECT dname FROM departments WHERE did = '$row[3]'";
											$dres = query($sql); $drow = fetch_array($dres); echo $drow[0]; 
											free_result($dres); 
										} else {
											echo 'All Divisions'; 
										} ?>">
