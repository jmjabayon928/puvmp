...
include("sqli.php");
include("html.php");
define('PAGE', 'd_special_order.php'); 
...
if (isset($_SESSION['user_id'])) {
	if (validate_level(PAGE) == true) {
		...
		if(isset($_POST['submitted'])) { // if submit button has been pressed
			...
			$sql = "DELETE FROM internals_special_orders
					WHERE sid = '$sid'
					LIMIT 1";
			if (query($sql)) {
				// log the activity
				log_user(3, 'internals_special_orders', $sid);
				
				header("Location: internals.php?tab=1&deleted_special_order=1");
				exit();
			} else {
				?>
				<div class="error">Could not delete special order because: <b><?PHP echo mysqli_error($connection) ?></b>.
			...
			<html lang="en">
			  <head>
				...
				<title>OTC | Delete Special Order</title>
			  ...
			  <body class="nav-md">
				<div class="container body">
				  <div class="main_container">
					...
					$sql = "SELECT DATE_FORMAT(so.sdate, '%m/%d/%y'), so.snum, 
							...
							<div class="x_panel">
							  <div class="x_content">
								<br />
									...
									<form action="d_special_order.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">Date of Special Order </label>
