...
if (isset($_SESSION['user_id'])) {
	if (validate_level3(PAGE) == true) {
		...
		if(isset($_POST['submitted'])) { // if submit button has been pressed
			...
			$sql = "DELETE FROM employees_eligibilities
					WHERE eeid = '$eeid'
					LIMIT 1";
			if (query($sql)) {
				// log the activity
				log_user(3, 'employees_eligibilities', $eeid);
				
				header("Location:employee.php?eid=".$eid."&success=1");
				exit();
			} else {
				?>
				<div class="error">Could not delete employee-eligibility because: <b><?PHP echo mysqli_error($connection) ?></b>.
							...
							<div class="x_panel">
							  <div class="x_content">
								<br />
									...
									<form action="d_eligibility.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
									  ...
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="ename">Career Service / RA 1080 </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="ename" name="ename" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $row[2] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="erating">Rating </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="erating" name="erating" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $row[3] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="edate">Date of Examination </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="date" id="edate" name="edate" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $row[4] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="eplace">Place of Examination </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="eplace" name="eplace" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $row[5] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="license_num">License No. (If Applicable) </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="license_num" name="license_num" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $row[6] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="license_exp">Date of Validity (If Applicable) </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="date" id="license_exp" name="license_exp" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $row[7] ?>">
										</div>
									  </div>
		...
		if ($emp_id != 0) {
			...
			<html lang="en">
			  <head>
				...
				<title>OTC - Delete Employee-Eligibililty</title>
