...
include("sqli.php");
include("html.php");
define('PAGE', 'd_memo_circular.php'); 
...
if (isset($_SESSION['user_id'])) {
	if (validate_level(PAGE) == true) {
		...
		if(isset($_POST['submitted'])) { // if submit button has been pressed
			...
			$sql = "DELETE FROM internals_memo_circulars
					WHERE cid = '$cid'
					LIMIT 1";
			if (query($sql)) {
				// log the activity
				log_user(3, 'internals_memo_circulars', $cid);
				
				header("Location: internals.php?tab=4&deleted_memo_circular=1");
				exit();
			} else {
				?>
				<div class="error">Could not delete memorandum circular because: <b><?PHP echo mysqli_error($connection) ?></b>.
			...
			<html lang="en">
			  <head>
				...
				<title>OTC | Delete Memorandum Circular</title>
			  ...
			  <body class="nav-md">
				<div class="container body">
				  <div class="main_container">
					...
					$sql = "SELECT DATE_FORMAT(mc.cdate, '%m/%d/%y'), mc.cnum, 
					  ...
					  <div class="">
						<div class="page-title">
						  <div class="title_left">
							<h3>Delete Memorandum Circular</h3>
						  </div>
							...
							<div class="x_panel">
							  <div class="x_content">
								<br />
									...
									<form action="d_memo_circular.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">Date of Memorandum Circular </label>
									  ...
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">Addressee </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
