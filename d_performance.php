...
if (isset($_SESSION['user_id'])) {
	if (validate_level(PAGE) == true) {
		...
		if(isset($_POST['submitted'])) { // if submit button has been pressed
			...
			$sql = "DELETE FROM employees_ratings
					WHERE rid = '$rid'
					LIMIT 1";
			if (query($sql)) {
				// log the activity
				log_user(3, 'employees_ratings', $rid);
				
				header("Location: hris.php?tab=4");
				exit();
			} else {
				?>
			...
			<html lang="en">
			  <head>
				...
				<title>OTC | Delete Performance Rating</title>
			  ...
			  <body class="nav-md">
				<div class="container body">
				  <div class="main_container">
					...
					if ($row[1] == 1) { $semester = '1st';
					} elseif ($row[1] == 2) { $semester = '2nd';
					}
					  ...
					  <div class="">
						<div class="page-title">
						  <div class="title_left">
							<h3>Delete Performance Rating</h3>
						  </div>
							...
							<div class="x_panel">
							  <div class="x_content">
								<br />
									...
									<form action="d_performance.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
									  ...
									  <div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $semester ?>">
										</div>
									  </div>
									  <div class="form-group">
