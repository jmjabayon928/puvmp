...
if (isset($_SESSION['user_id'])) {
	if (validate_level(PAGE) == true) {
		...
		if(isset($_POST['submitted'])) { // if submit button has been pressed
			...
			$sql = "DELETE FROM employees_hirings
					WHERE hid = '$hid'
					LIMIT 1";
			if (query($sql)) {
				// log the activity
				log_user(3, 'employees_hirings', $hid);
				
				header("Location: hris.php?tab=1");
				exit();
			} else {
				?>
				<div class="error">Could not delete hiring because: <b><?PHP echo mysqli_error($connection) ?></b>.
							...
							<div class="x_panel">
							  <div class="x_content">
								<br />
									...
									<form action="d_hiring.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
									  ...
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" >Date of Hiring</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
