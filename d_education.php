...
if (isset($_SESSION['user_id'])) {
	if (validate_level3(PAGE) == true) {
		...
		if(isset($_POST['submitted'])) { // if submit button has been pressed
			...
			$sql = "DELETE FROM employees_schools
					WHERE sid = '$sid'
					LIMIT 1";
			if (query($sql)) {
				// log the activity
				log_user(3, 'employees_schools', $sid);
				
				header("Location:employee.php?eid=".$eid."&success=1");
				exit();
			} else {
				?>
				<div class="error">Could not delete employee-education information because: <b><?PHP echo mysqli_error($connection) ?></b>.
			...
			<html lang="en">
			  <head>
				...
				<title>OTC | Delete Employee-Education Information</title>
					  ...
					  <div class="">
						<div class="page-title">
						  <div class="title_left">
							<h3>Delete Employee-Education Information</h3>
						  </div>
							...
							<div class="x_panel">
							  <div class="x_content">
								<br />
									...
									<form action="d_education.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
									  ...
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="ecode">Level </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="ecode" name="ecode" readonly class="form-control col-md-7 col-xs-12" value="<?php 
											if ($row[2] == 1) { echo 'Elementary';
											} elseif ($row[2] == 2) { echo 'Secondary';
											} elseif ($row[2] == 3) { echo 'Vocational / Trade Course';
											} elseif ($row[2] == 4) { echo 'College';
											} elseif ($row[2] == 5) { echo 'Master\'s Degree';
											} elseif ($row[2] == 6) { echo 'Doctor of Philosphy';
											}
											?>">
										</div>
									  </div>
									  <div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="school" name="school" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $row[3] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="degree">Degree <span class="required">*</span></label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="degree" name="degree" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $row[4] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="sstart">From (YYYY) <span class="required">*</span></label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="sstart" name="sstart" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $row[5] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="send">To (YYYY) <span class="required">*</span></label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="send" name="send" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $row[6] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="level_earned">Level / Units Earned </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="level_earned" name="level_earned" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $row[7] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="grad_yr">Year Graduated (YYYY) </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="grad_yr" name="grad_yr" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $row[8] ?>">
										</div>
									  </div>
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="honors">Honors Received </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										  <input type="text" id="honors" name="honors" readonly class="form-control col-md-7 col-xs-12" value="<?php echo $row[9] ?>">
										</div>
									  </div>
				...
				if ($emp_id == $eid) {
					...
					<html lang="en">
					  <head>
						...
						<title>OTC - Delete Employee-Education</title>
