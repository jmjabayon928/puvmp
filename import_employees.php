				...
				if ($extension != 'csv') {
					...
					if (($handle = fopen($file, "r")) !== FALSE) {
						...
						while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
							...
							$pcs = explode(",", $name);
							$lname = $pcs[0]; $fname = $pcs[1]; $mname = $pcs[2];
							...
							$sql = "INSERT INTO employees( etype, fname, mname, lname, sex, did, pid, sgid, sglevel, active )
									VALUES( '$etype', '$fname', '$mname', '$lname', '$sex', '$did', '$pid', '$sgid', '$sglevel', '1' )";
							query($sql); 
						...
						<div class="row">
						  ...
						  <div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
							  ...
							  <div class="x_content">
								<form id="contact-form" name="contact-form" action="import_employees.php" method="POST" enctype="multipart/form-data">					
									<fieldset>
