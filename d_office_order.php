...
include("sqli.php");
include("html.php");
define('PAGE', 'd_office_order.php'); 
...
if (isset($_SESSION['user_id'])) {
	if (validate_level(PAGE) == true) {
		...
		if(isset($_POST['submitted'])) { // if submit button has been pressed
			...
			$sql = "DELETE FROM internals_office_orders
					WHERE oid = '$oid'
					LIMIT 1";
			if (query($sql)) {
				// log the activity
				log_user(3, 'internals_office_orders', $oid);
				
				header("Location: internals.php?tab=2&deleted_office_order=1");
				exit();
			} else {
				?>
				<div class="error">Could not delete office order because: <b><?PHP echo mysqli_error($connection) ?></b>.
			...
			<html lang="en">
			  <head>
				...
				<title>OTC | Delete Office Order</title>
			  ...
			  <body class="nav-md">
				<div class="container body">
				  <div class="main_container">
					...
					$sql = "SELECT DATE_FORMAT(oo.odate, '%m/%d/%y'), oo.onum, 
							...
							<div class="x_panel">
							  <div class="x_content">
								<br />
									...
									<form action="d_office_order.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
									  <div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">Date of Office Order </label>
